...
assert.match(topbarActions, /inline-flex size-9 items-center justify-center rounded-md text-khata-muted/);
assert.match(topbarActions, /rounded-full bg-khata-paperMuted\/70 px-2 py-1/);
...
assert.match(topbarActions, /max-w-2xl/);
assert.match(topbarActions, /aria-label="Close search"/);
assert.match(topbarActions, /Selected/);
