...
assert.match(layout, /dashboard_sidebar\.review_queue_count/);
assert.match(layout, /dashboard_sidebar\.inbox_count/);
assert.match(layout, /<DashboardSidebar[\s\S]*counts=\{sidebarCounts\}/);
...
assert.match(topbarActions, /bg-slate-950\/50/);
assert.match(topbarActions, /commandDialogPanelClassName/);
assert.match(designSystem, /max-w-xl/);
assert.match(topbarActions, /createPortal\(/);
...
assert.match(navigation, /countBadgeForHref/);
assert.match(navigation, /href === "\/dashboard\/inbox"/);
assert.match(navigation, /href === "\/dashboard\/review-queue"/);
assert.match(navigation, /formatBadgeCount/);
...
assert.doesNotMatch(navigation, /"\/dashboard\/platform"/);
