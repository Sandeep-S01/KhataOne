...
assert.match(reviewQueue, /<FilterBar action="\/dashboard\/review-queue" className="gap-0 overflow-hidden p-0">/);
...
assert.match(reviewQueue, /<FilterGrid className="md:grid-cols-2 xl:grid-cols-\[220px_220px_200px_160px_160px_auto\]">/);
assert.match(reviewQueue, /<FilterActions className="xl:justify-end">/);
