  ...
  theme: {
    extend: {
      colors: {
        ...
        "primary-foreground": rgbVar("--primary-foreground-rgb"),
        ...
        "destructive-button-foreground": rgbVar("--destructive-button-foreground-rgb"),
        "ink-foreground": rgbVar("--ink-foreground-rgb"),
